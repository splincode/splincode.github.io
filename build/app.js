  ...
  var obj = $('.frameSlider');
    ...
    if (this.xframe > 1) {
      ...
      var arrayText = [
        ...
        "Верстка PSD-макета",
        "В университете занимались проектированием сервера на C++, я занимался разработкой клиентской части (angularJS) социальной сети вуза, который работал на сервере",
        "Мой первый опыт проектирования промо-страниц, также разработал на PHP и ASP гостевую книгу с валидацией",
        "Написание гостевой книги с использованием Mootools, написание дополнительного движка управления на php, оформление на css3",
        "Создание лэндинга на основе bootstap + jQuery",
        "Создал простую CMS на основе Slim Framework, на клиентской стороне использовал собственный плагин для реализации Ajax-приложения",
        "Сайт с конкурса веб-проектов 2012 года, работал первый раз с анимациями jQuery + CSS3",
        "Собирал материалы для университетский курсов по HTML, создал промо-страницу + слайдер-содержание",
        "Собирал материалы для университетский курсов по CSS",
        "Собирал материалы для университетский курсов по верстке сайтов",
        "Создание лэндинга для компании \"Росохрана\", написание анимации на jQuery UI",
        "Создание слайдера под мобильные устройства на jQuery Mobile",
        "Занимался оформление групп вконтакте, работал с API вконтакта для вывода информации с сайта в группу на PHP",
        "Перевод сайта Transformicons + написание плагина по управлению SVG-анимации",
        "Создание CMS на Slim Framework + написание классов для работы с MySQL",
        "Разработка интерфейса интернет-магазина на jQuery UI",
        "Создание bash-скрипта по установке LAMP с веб-интерфейсом управления хостами",
        "Создание интерфейса для личного сайта фрилансера (HTML5, CSS, AngularJS)",
        "Создание дизайна интернет-магазина, верстка макета",
        "Создание онлайн-сервиса по ведению дел, использование API Вконтакте, HTML5 localstorage",
        "Скрипт (js) по отображению кода на странице с выбором подсветки",
        "Дизайн интернет-магазина, верстка",
        "Создание кроссбраузерного загрузчика файлов на HTML5 (Drag and Drop) с использованием API File",
        "Написание собственного CSS-препроцессора на JavaScript с использованием jQuery (подгрузка файлов для препроцессинга)",
        "Перевод документации по управлению ISP-панели хостинга, написание API на PHP по управлению, создание сайта с документацией",
        "Написание интерфейса для админ-панели под ModX",
        "Создание сайта-визитку с использование jQuery + FancyBox",
      ];
